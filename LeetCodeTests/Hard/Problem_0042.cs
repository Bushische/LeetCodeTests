        ...
        */
        public static void Test()
        {
            ...
            */
            ...
            Console.WriteLine(
                $"for input: '{Utils.PrintArray(input)}' -> {sol.Trap(input)} waits 6"
            );

            input = new int[] { 4, 2, 3, 5, 2, 3, 4, 5 };
            Console.WriteLine(
                $"for input: '{Utils.PrintArray(input)}' -> {sol.Trap(input)} waits 9"
            );

            input = new int[] { 8, 7, 6, 5, 4, 3, 2, 1 };
            Console.WriteLine(
                $"for input: '{Utils.PrintArray(input)}' -> {sol.Trap(input)} waits 0"
            );
...
Expected:1
            */
            input = new int[] { 4, 2, 3 };
            Console.WriteLine(
                $"for input: '{Utils.PrintArray(input)}' -> {sol.Trap(input)} waits 1"
            );

            input = new int[] { 9, 1, 8, 1, 7, 1, 6 };
            Console.WriteLine(
                $"for input: '{Utils.PrintArray(input)}' -> {sol.Trap(input)} waits 18"
            );
        }
