        ...
        */
        public static void Test()
        {
            ...
            */
            ...
            input = "abc";
            Console.WriteLine(
                $"Input '{input}' -> is Number = '{sol.IsNumber(input)}' waits FALSE"
            );
...
-2e-3
        */
        ...
        {
            private HashSet<char> digitChars = new HashSet<char>()
            {
                '0',
                '1',
                '2',
            ...
            public bool IsNumber(string s)
            {
                ...
                if (eind > -1)
                    return CheckBase(s.Substring(left, eind - left))
                        && CheckExp(s.Substring(eind + 1, right - eind));
                else
