        ...
        */
        public static void Test()
        {
            ...
            */
            ...
            var n = 4;
            Console.WriteLine(
                $"Original list: '{Utils.PrintList(List)}'. Try reverse from {m} to {n}"
            );
            Console.WriteLine(
                $"Rotated list:  '{Utils.PrintList(sol.ReverseBetween(List, m, n))}' (waits 1-4-3-2-5)"
            );
            ...
            Console.WriteLine(
                $"Rotated list:  '{Utils.PrintList(sol.ReverseBetween(List, m, n))}' (waits 5-4-3-2-1)"
            );
        }
