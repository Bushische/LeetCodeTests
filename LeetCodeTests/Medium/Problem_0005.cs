        ...
        */
        public static void Test()
        {
            ...
            */
            ...
            Console.WriteLine(
                $"check for palindrome 'ababa' = {sol.FindPalindromFromCenter("ababa", 2, 2)}"
            );
            Console.WriteLine(
                $"check for palindrome 'bb' = {sol.FindPalindromFromCenter("bb", 0, 0)}"
            );
            Console.WriteLine(
                $"check for palindrome 'bb' = {sol.FindPalindromFromCenter("bb", 0, 1)}"
            );

            var input = "babad";
            Console.WriteLine(
                $"For input '{input}' longest palindrome is '{sol.LongestPalindrome(input)}'. Waits 'bab'/'aba'"
            );

            input = "cbbd";
            Console.WriteLine(
                $"For input '{input}' longest palindrome is '{sol.LongestPalindrome(input)}'. Waits 'bb'"
            );

            input = "abcdefgh"; // nothing
            Console.WriteLine(
                $"For input '{input}' longest palindrome is '{sol.LongestPalindrome(input)}'. Waits 'a'/''b'..."
            );

            input = "abcdcefgh";
            Console.WriteLine(
                $"For input '{input}' longest palindrome is '{sol.LongestPalindrome(input)}'. Waits 'cdc'"
            );
            ...
            input = "abcda";
            Console.WriteLine(
                $"For input '{input}' longest palindrome is '{sol.LongestPalindrome(input)}'. Waits 'a'"
            );
