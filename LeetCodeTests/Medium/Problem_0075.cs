...
Expected:[0,1,1,1,1,1,2,2]
        ...
        { // the list of 0, 1 and 2
            public void SortColors(int[] nums)
            {
                ...
                while (ind0 < ind2)
                {
                    while ((nums[ind0] == 0) && (ind0 < ind2))
                        ind0++;
                    while ((nums[ind2] == 2) && (ind0 < ind2))
                        ind2--;
                    while ((ind1 < ind2) && (ind0 < ind1) && (nums[ind1] == 1))
                        ind1 += ind1dx;
                    if (ind0 >= ind2)
                        return;
                    if (ind1 < ind0)
                    ...
                    else if (ind1 > ind2)
                    {
                        ...
                        ((nums[ind0] != 0) && (nums[ind2] == 0))
                        || ((nums[ind2] != 2) && (nums[ind0] == 2))
                    )
                        Swap(ind0, ind2);
                    else if (
                        ((nums[ind0] != 0) && (nums[ind1]) == 0)
                        || ((nums[ind1] != 1) && (nums[ind0] == 1))
                    )
                        Swap(ind0, ind1);
                    else if (
                        ((nums[ind2] != 2) && (nums[ind1] == 2))
