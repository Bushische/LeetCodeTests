        ...
        */
        public static void Test()
        {
            ...
            */
            ...
            var divisor = 3;
            Console.WriteLine(
                $" {dividend} / {divisor} = {sol.Divide(dividend, divisor)} wait {dividend / divisor}"
            );
            ...
            divisor = 0;
            Console.WriteLine(
                $" {dividend} / {divisor} = {sol.Divide(dividend, divisor)} wait +oo"
            );
            ...
            public int Divide(int dividend, int divisor)
            {
                try
                {
                    ...
                    res = checked(
                        res
                        + Divide(
                            (sign1 > 0) ? dividend : -dividend,
                            (sign2 > 0) ? divisor : -divisor
                        )
                    );
