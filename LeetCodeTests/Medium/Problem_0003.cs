        ...
        */
        public static void Test()
        {
            ...
            */
            string s = "abcabcbb";
            Console.WriteLine(
                $"for line '{s}' answer is {sol.LengthOfLongestSubstring(s)} (should be 3)"
            );

            s = "bbbbbb";
            Console.WriteLine(
                $"for line '{s}' answer is {sol.LengthOfLongestSubstring(s)} (should be 1)"
            );
            ...
            s = "ababababba";
            Console.WriteLine(
                $"for line '{s}' answer is {sol.LengthOfLongestSubstring(s)} (should be 2)"
            );

            s = "1234567";
            Console.WriteLine(
                $"for line '{s}' answer is {sol.LengthOfLongestSubstring(s)} (should be 7)"
            );
        }
