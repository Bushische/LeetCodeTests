        ...
        */
        public static void Test()
        {
            ...
            */
            ...
            var target = 8;
            Console.WriteLine(
                $"Find '{target}' in array '{Utils.PrintArray(nums)}' -> '{sol.Search(nums, target)}' waits (-1)"
            );
            ...
            target = 1;
            Console.WriteLine(
                $"Find '{target}' in array '{Utils.PrintArray(nums)}' -> '{sol.Search(nums, target)}' waits (5)"
            );

            target = 2;
            Console.WriteLine(
                $"Find '{target}' in array '{Utils.PrintArray(nums)}' -> '{sol.Search(nums, target)}' waits (6)"
            );

            target = 7;
            Console.WriteLine(
                $"Find '{target}' in array '{Utils.PrintArray(nums)}' -> '{sol.Search(nums, target)}' waits (3)"
            );

            target = 4;
            Console.WriteLine(
                $"Find '{target}' in array '{Utils.PrintArray(nums)}' -> '{sol.Search(nums, target)}' waits (0)"
            );
            ...
            target = 2;
            Console.WriteLine(
                $"Find '{target}' in array '{Utils.PrintArray(nums)}' -> '{sol.Search(nums, target)}' waits (2)"
            );
