        ...
        */
        public static void Test()
        {
            ...
            */
            ...
            int n = 7;
            Console.WriteLine(
                $"For m={m} and n={n} -> {sol.UniquePaths(m, n)} unique paths (wait 28)"
            );

            m = 1;
            n = 7;
            Console.WriteLine(
                $"For m={m} and n={n} -> {sol.UniquePaths(m, n)} unique paths (wait 1)"
            );
            ...
            n = 2;
            Console.WriteLine(
                $"For m={m} and n={n} -> {sol.UniquePaths(m, n)} unique paths (wait 7)"
            );
