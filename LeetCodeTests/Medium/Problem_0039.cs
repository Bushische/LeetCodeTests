        ...
        */
        public static void Test()
        {
            ...
            */
            ...
            int target = 7;
            Console.WriteLine(
                $"For input '{Utils.PrintArray(input)}' and target '{target}': {Utils.PrintArray(sol.CombinationSum(input, target))}"
            );
        }
        ...
        public class Solution
        {
            ...
            {
                if (curList.Count > 20)
                    return; // just to avoid 0 numbers infinite row
