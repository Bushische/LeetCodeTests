        ...
        */
        public static void Test()
        {
            ...
            */
            ...
            k = 5;
            Console.WriteLine(
                $"For n={n} and k={k} -> '{sol.GetPermutation(n, k)}' (waits '1423')"
            );

            k = 10;
            Console.WriteLine(
                $"For n={n} and k={k} -> '{sol.GetPermutation(n, k)}' (waits '2341')"
            );

            k = 15;
            Console.WriteLine(
                $"For n={n} and k={k} -> '{sol.GetPermutation(n, k)}' (waits '3214')"
            );

            k = 20;
            Console.WriteLine(
                $"For n={n} and k={k} -> '{sol.GetPermutation(n, k)}' (waits '4132')"
            );
        }
