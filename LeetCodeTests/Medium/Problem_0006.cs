        ...
        */
        public static void Test()
        {
            ...
            */
            ...
            int numRows = 3;
            Console.WriteLine(
                $"for input '{input}' -> '{sol.Convert(input, numRows)}', wait 'PAHNAPLSIIGYIR'"
            );

            input = "ABCDEFGHIJKLMN";
            numRows = 3;
            Console.WriteLine(
                $"for input '{input}' -> '{sol.Convert(input, numRows)}', wait 'AEIMBDFHJLNCGK'"
            );

            input = "ABCDEFGHIJKLMN";
            numRows = 4;
            Console.WriteLine(
                $"for input '{input}' -> '{sol.Convert(input, numRows)}', wait 'AGMBFHLNCEIKDJ'"
            );
